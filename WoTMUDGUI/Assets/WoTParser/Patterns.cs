...
namespace WoTParser {
    ...
    public class Patterns {
        ...
        static Patterns() {
            ...
            blockMediator.Add(new string[] { PlacePatterns.darkPattern }, new Action<string>(Place.SetDarkPlace));
            blockMediator.Add(PlayerPatterns.cantMovePatterns, new Action<string>(Player.BadMove));
            //blockMediator.Add(new string[] { PlacePatterns.darkPlaceExits }, new Action<string>(Place.DarkPlaceExits));
            lineMediator.Add(new string[] { PlacePatterns.newArrivalPattern }, new Action<string>(Place.NewArrival));
            //Player
        ...
        internal class PlacePatterns {
            public const string startHeadingPattern = ".\\[36m",
                                ...
                                placePattern = ".\\[36m(.*)\\[0m"+ ANY_CHARACTERS + verboseExits;
            public const string darkExitPattern = "Too dark to tell";
            public const string newArrivalPattern = "A " + ANY_CHARACTERS + " has arrived from the " + ANY_CHARACTERS + ".";
            public const string darkPattern = "It is pitch black...";
            public const string verboseExits = "Obvious exits:"
                +"(North - "+ANY_CHARACTERS+")?"
                +"(East  - "+ANY_CHARACTERS+")?"
                +"(South - "+ANY_CHARACTERS+")?"
                +"(West  - "+ANY_CHARACTERS+")?";
        }
        ...
        public class PlayerPatterns {
            ...
            //Movement
            public static string[] cantMovePatterns = {
                    "Alas, you cannot go that way...",
                    "You are too exhausted.",
                    "In your dreams, or what?",
                    "Maybe you should get on your feet first?",
                    ANY_CHARACTERS+" seems to be closed."
            };
            ...
            public static string[] trashLinePatterns = new string[] { 
                ...
                "You pass through "+ANY_CHARACTERS+".",
                "\\[32m\\[33m\\[0m"
                //"(\n|\r)"
            };
        }
        ...
        private static void DisposeTrashLines(string trashline){
            /*These are undeeded lines, do nothing*/
            UnityEngine.Debug.Log(trashline);
        }
